...
#import "iDemotivationalAppDelegate.h"
#import "iDemotivationalViewController.h"

@implementation iDemotivationalAppDelegate
...
- (void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info {
	...
	if ([info objectForKey:@"UIImagePickerControllerEditedImage"] != NULL) {
		[viewController setPhoto:[info objectForKey:@"UIImagePickerControllerEditedImage"]];
	}else {
		[viewController setPhoto:[info objectForKey:@"UIImagePickerControllerOriginalImage"]];
	}
